                ...
                <td align="center" valign="middle">
                    <div>
                        ...
                        <div id="content" style="display:none">
                            ...
                            <h1>Accessing http://ieeesbcet.org/wp-includes/js/comment-reply.min.js?ver=4.7.5 securely…</h1>
                        ...
                        <form id="challenge-form" action="/verify.php" method="post">
                            <input type="hidden" name="hash" value="43dd66757a719d49c0f1edbce52cc3755a1ea5bd"/>
                            <input type="hidden" name="origin_url" value="http://ieeesbcet.org/wp-includes/js/comment-reply.min.js?ver=4.7.5"/>
                        </form>
                    </div>
